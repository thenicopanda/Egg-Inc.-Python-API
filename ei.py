...
def get_first_contact(ei_user_id):
    ...
    response = requests.post("https://www.auxbrain.com/ei/bot_first_contact", data = { 'data' : b64encode(first_contact_request.SerializeToString()).decode('utf-8') })
...
"""
print(get_first_contact("EI5450109629759488"))
print(get_periodicals("EI5450109629759488"))
print(get_config("EI5450109629759488"))
print(get_afx_config("EI5450109629759488"))
print(get_daily_gift_info())
print(get_coop_status("EI5450109629759488", "heat-wave-2022", "bridecinch7"))
"""